...
void ws(std::function<void(std::string)> send_, boost::asio::io_context& ioc, std::string input, std::set<std::string>& scopes, boost::optional<cw::batch::System>& selectedSystem);
